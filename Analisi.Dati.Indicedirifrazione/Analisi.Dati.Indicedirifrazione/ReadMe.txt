========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto Analisi.Dati.Indicedirifrazione
========================================================================

La creazione guidata applicazione ha creato questa applicazione Analisi.Dati.Indicedirifrazione.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione Analisi.Dati.Indicedirifrazione.


Analisi.Dati.Indicedirifrazione.vcxproj
...
Analisi.Dati.Indicedirifrazione.vcxproj.filters
...
Analisi.Dati.Indicedirifrazione.cpp
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Analisi.Dati.Indicedirifrazione.pch e il file dei tipi precompilato StdAfx.obj.
